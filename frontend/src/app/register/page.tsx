    ...
    <div className="min-h-screen flex" style={{ background: 'var(--background)' }}>
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden" style={{ background: 'var(--surface)' }}>
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-1/3 right-1/3 w-[500px] h-[500px] rounded-full opacity-40" style={{ background: 'radial-gradient(circle, var(--accent-muted) 0%, transparent 70%)' }} />
        </div>
        ...
        <div className="relative flex flex-col justify-center px-16 z-10">
          ...
          <p className="text-sm max-w-md leading-relaxed" style={{ color: 'var(--text-tertiary)' }}>
            Create your account and join thousands of creators sharing their best work with the world.
          </p>
            ...
            <div className="flex -space-x-2">
              {[1, 2, 3, 4, 5].map((i) => (
                <img
                  ...
                  style={{ border: '2px solid var(--surface)', boxShadow: 'var(--shadow-sm)' }}
                />
              ))}
            </div>
            <p className="text-sm" style={{ color: 'var(--text-tertiary)' }}>
              <span className="font-medium" style={{ color: 'var(--foreground)' }}>10,000+</span> creators already here
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="w-full max-w-sm">
          ...
          <div className="grid grid-cols-2 gap-2.5 mb-6">
            <a
              ...
              className="flex items-center justify-center gap-2 px-4 py-2.5 text-sm font-medium transition-colors duration-200 hover:opacity-90"
              style={{
          ...
          <form onSubmit={handleSubmit} className="space-y-3.5">
            ...
            <button type="submit" disabled={isLoading} className="btn-primary w-full py-2.5 gap-2">
              {isLoading ? (
