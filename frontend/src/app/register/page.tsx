...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] flex">
      {/* Left - Art */}
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-gradient-to-br from-purple-600 via-brand-700 to-indigo-800">
        ...
        <div className="relative flex flex-col justify-center px-16 text-white">
          ...
          <h2 className="text-4xl font-bold mb-4 leading-tight">
            Join the Creative<br />Community
          </h2>
          <p className="text-lg text-white/70 max-w-md">
            Create, share, and discover products with AI-powered image generation and a vibrant community.
          </p>
          <div className="mt-12 flex items-center gap-4">
            ...
            <p className="text-sm text-white/70">
              <span className="font-semibold text-white">10,000+</span> creators already joined
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-6">
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            ...
            <p className="text-surface-500">Start your creative journey today</p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-3 mb-6">
            <a
              ...
              className="flex items-center justify-center gap-2 px-4 py-3 rounded-xl border border-surface-200 dark:border-surface-700 
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-white dark:bg-surface-950 px-3 text-surface-400">or</span>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button type="submit" disabled={isLoading} className="btn-primary w-full py-3 text-base gap-2">
              {isLoading ? (
