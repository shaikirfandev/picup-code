...
import RecommendationsPanel from '@/components/ads-insight/RecommendationsPanel';
...
export default function RecommendationsPage() {
  ...
  if (!isAuthenticated || !isPaid) {
    return <div className="min-h-screen flex items-center justify-center"><Sparkles className="w-12 h-12 text-[var(--accent)] animate-pulse" /></div>;
  }
